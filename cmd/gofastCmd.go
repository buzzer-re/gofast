...
var gofastCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		var response fastHttp.FastResponse = fastHttp.GetResponse(cmdArgs.Url, cmdArgs.IgnoreSSL)
		if cmdArgs.OutFile != "" {
...
func init() {
	...
	gofastCmd.Flags().BoolVarP(&cmdArgs.IgnoreSSL, "ignore-certificate", "k", false, "Ignore SSL certificate")
}
